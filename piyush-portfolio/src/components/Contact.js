    ...
    <div name="contact" className="w-full h-screen bg-[#0a192f] text-gray-300">
      <div className='h-full w-full max-w-[1000px] mx-auto flex flex-col justify-center p-4'>
        <form method="POST" action="https://getform.io/f/d2d0e0ce-ade1-4c41-831a-c6e1479474a6" className='flex flex-col w-full max-w-[600px]'>
          ...
          <input data-aos="fade-right" className='bg-[#ccd6f6] p-2 text-gray-700' type='text' placeholder='Name' name='name'></input>
          <input data-aos="fade-right" className='bg-[#ccd6f6] p-2 my-2 text-gray-700' type='email' placeholder='Email' name='email'></input>
          <textarea data-aos="fade-right" className='bg-[#ccd6f6] p-2 text-gray-700' type='textarea' rows="7" placeholder='Message' name='message'></textarea>
          <button data-aos="zoom-out" className='text-white border-2 px-4 py-2 my-3 flex items-center justify-center hover:bg-pink-600 hover:border-pink-600 duration-[400ms] group sm:w-[220px]'>
